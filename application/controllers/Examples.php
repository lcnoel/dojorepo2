...
class Main extends CI_Controller {
    ...
    public function miembros()
    {
        ...
        $crud->columns('nmiembro','nombre','apellido','movil','dojo','grado','estado','fechaingreso');
        //$crud->columns('customerName','contactLastName','phone','city','country','salesRepEmployeeNumber','creditLimit');
        $crud->display_as('nmiembro',    'Miembro #')
            ->display_as('nombre',      'Nombre')
            ->display_as('apellido',    'Apellido')
            ->display_as('movil',       'Móvil')
            ->display_as('dojo',        'Dojo')
            ->display_as('grado',       'Grado')
